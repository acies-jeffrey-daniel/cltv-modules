    ...
    for col in df_temp.columns:
        if pd.api.types.is_datetime64_any_dtype(df_temp[col]):
            ...
            try:
                ...
                # Using errors='coerce' to allow partial conversion for robust checking if needed,
                # but for strict 'is it a datetime column' we stick to 'raise'
...
st.sidebar.info(
    ...
    outlier capping, and collinearity/VIF analysis.
    """
)
st.sidebar.markdown("---")
